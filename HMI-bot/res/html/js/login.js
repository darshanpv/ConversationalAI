    ...
    function validateLoginForm(e) {
        ...
        if (username == "John" && password == "John123") {
            ...
            posting.done(function (data) {
                ...
                if (username == "") {
                    ...
                    $('#password').focus();
                    return false;
                } else if (checkAuthenticUser == "true" /*|| username == "JohnDoe" && password=="JohnDoe123" */ && password == "We1com3") {
                    ...
                    return false;
                } else if (username != '' && password != '' && checkAuthenticUser == "true" /*|| username == "JohnDoe" && password=="JohnDoe123"*/ ) {
                    credentialPass();
                    return false;
                } else {
        ...
        function initialCall() {
            ...
            $.post(location1 + "/bot", {
                    ...
                    console.log(data);
                    currentTime();
                    systemUtteranceContent = '<li class="mar-btm systemUtterance"> <div class="media-body pad-hor"> <div class="speech"> <p id="systemUtterance">' + msg + ', ' + data + '</p><p class="speech-time"><i class="fa fa-clock-o fa-fw"></i>' + currentTime() + '</p> </div></div></li>';
                    $('#loading').hide();
