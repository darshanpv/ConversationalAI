...
public class PredictModel {
	...
	public static DialogObject predict(String domain, String locale, String utterance) {
		...
		try {
			...
			NLPEngineURL = prop.getProperty("NLP_ENGINE_URL") + "/predict";
			...
			if (status == 200 || status == 201) {
				logger.info("[NLP_ENGINE] response: " + response.getContentAsString());
