...
public class NerGetMoney {
	public static List<String> MONEY = new ArrayList<String>();
				...
				for (int i = 0; i < elementsList.getLength(); i++) {
					if (elementsList.item(i).hasChildNodes()) {
						...
						for (int i2 = 0; i2 < tagsList.getLength(); i2++) {
							...
							if (tagNode.getNodeName().matches("MONEY"))
								MONEY.add(tagNode.getTextContent());
